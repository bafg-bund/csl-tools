def var_regex_mbank():
    ...
    mbank_var_regex = {
        ...
        'var_smiles': 'CH\\$SMILES:',                           # Simplified Molecular Line Entry Specification (SMILES)
        ...
        'var_col_type': 'AC\\$MASS_SPECTROMETRY: FRAGMENTATION_MODE',  # Collision type / Fragmentation mode  Todo: remember to CID -> ? check export
