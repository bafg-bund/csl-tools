...
DEFAULT_GAM_BFG_TO_LANUV_PATH = 'csl/rtscan_functions/rtscan_workflow_utils/gam_bfg_to_lanuv.pkl'
DEFAULT_GAM_LANUV_TO_BFG_PATH = 'csl/rtscan_functions/rtscan_workflow_utils/gam_lanuv_to_bfg.pkl'
