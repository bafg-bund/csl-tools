...
```
cd existing_repo
git remote add origin https://gitlab.lan.bafg.de/nts/collective-spectral-library.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.lan.bafg.de/nts/collective-spectral-library/-/settings/integrations)
