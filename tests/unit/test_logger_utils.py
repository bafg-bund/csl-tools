...
def test_setup_logger():
    ...
    with patch('logging.getLogger') as mock_get_logger, \
        ...
        # Assert that the StreamHandler was instantiated
        mock_stream_handler.assert_called_once()
        # Assert that setFormatter was called on the handler instance with ColoredFormatter
        ...
        # Assert that addHandler was called on the logger with the handler instance
...
def test_setup_logger_existing_handler():
    ...
    with patch('logging.getLogger') as mock_get_logger:
        ...
        # Assert that no new StreamHandler was added since one already exists
