...
@patch('process_functions.lfuby_workflow.get_polarity', return_value='polarity')
@patch('process_functions.lfuby_workflow.get_compound_and_adduct_name', return_value=('comp', 'adduct'))
@patch('process_functions.lfuby_workflow.format_adduct', return_value='formatted_adduct')
@patch('process_functions.lfuby_workflow.get_collision_energy', return_value=('ce', 'ces', False))
@patch('process_functions.lfuby_workflow.get_ionization_type', return_value='ionization_type')
@patch('process_functions.lfuby_workflow.get_formula', return_value='formula')
@patch('process_functions.lfuby_workflow.get_inchikey', return_value=('inchikey', 'inchikey_main'))
@patch('process_functions.lfuby_workflow.get_cas', return_value='cas')
@patch('process_functions.lfuby_workflow.get_smiles', return_value='smiles')
@patch('process_functions.lfuby_workflow.get_inchi_from_smiles', return_value='inchi')
...
def test_process_data(mock_get_compound_group, mock_get_peaks, mock_get_retention_time, mock_get_precursor_mz,
    ...
    workflow = LfubyWorkflow(path_data='dummy_data_path', path_csl='dummy_csl_path')
...
@patch('process_functions.lfuby_workflow.get_ionization_type', return_value='ionization_type')
@patch('process_functions.lfuby_workflow.get_formula', return_value='formula')
@patch('process_functions.lfuby_workflow.get_inchikey', return_value=(None, None))
@patch('process_functions.lfuby_workflow.get_cas', return_value=None)
@patch('process_functions.lfuby_workflow.get_smiles', return_value='smiles')
@patch('process_functions.lfuby_workflow.get_inchi_from_smiles', return_value='inchi')
@patch('process_functions.lfuby_workflow.get_precursor_mz', return_value=99)
@patch('process_functions.lfuby_workflow.get_retention_time', return_value=99)
...
def mock_dependencies_match_with_csl():
    ...
    with patch('process_functions.lfuby_workflow.create_session') as mock_create_session, \
            patch('process_functions.lfuby_workflow.check_duplicate') as mock_check_duplicate, \
            patch('process_functions.lfuby_workflow.add_exp_to_session') as mock_add_exp_to_session:
