...
def extract_data_regex_lubw(file_path, var_regex):
    """
        ...
        for variable in var_regex.items():
            ...
            if var_key != 'var_peak':
                for line in chunk.strip().split('\n'):
                    ...
                    if match:
                        delim = '=' if '=' in line else '[|]'  # todo: differs from other workflows
    ...
    chunk_identifier = 'MS:1009003|Name'  # todo: differs from other workflows
